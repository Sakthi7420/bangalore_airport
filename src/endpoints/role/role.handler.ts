...
export const assignPermissionsHandler: EndpointHandler<EndpointAuthType.JWT
> = async (
  req: EndpointRequestType[EndpointAuthType.JWT],
  res: Response) => {
...
export const getPermissionsHandler: EndpointHandler<EndpointAuthType.JWT> = async (
  req: EndpointRequestType[EndpointAuthType.JWT],
  res: Response) => {
  try {
...
export const createPermissionHandler: EndpointHandler<EndpointAuthType> = async (
...
export const updatePermissionHandler: EndpointHandler<EndpointAuthType.JWT> = async (
  req: EndpointRequestType[EndpointAuthType.JWT],
  res: Response) => {
...
export const deletePermissionHandler: EndpointHandler<EndpointAuthType.JWT> = async (
  req: EndpointRequestType[EndpointAuthType.JWT],
  res: Response) => {
